...
/// Fleet manager ACCOUNT tab — mirrors the student/driver Account tab
/// exactly: name + rating header, "Safety checkup" promo card, and menu
/// rows (Profile, Settings, Support). Profile/Settings/Support are the same
/// shared screens the student app uses — they only touch the generic
/// AuthenticationProvider, so they work identically for a fleet manager
/// account.
            ...
            Padding(
              ...
              child: Consumer<AuthenticationProvider>(
                builder: (context, auth, _) {
                  final name = auth.user?.name ?? 'Fleet Manager';
